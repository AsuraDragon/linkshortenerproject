...
### Provided Architecture Information & Coding Standards:
<!-- 
Paste your raw architecture notes, guidelines, or requirements below.
If you have a target filename in mind (e.g. `auth.md` or `database.md`), include it here.
If left blank, the agent will prompt you to provide the details.
-->
